...
function uploadFiles(form) {
  try {
    ...
    var home = "https://script.google.com/macros/s/AKfycbwsfKtUo9w0B_T9NULthvNYdKSHJfUk5Iy95Jjf1qr-FALl4SqB/exec";
    ...
    var ss = SpreadsheetApp.openById("1prwrwlxC50vjr0vGoBYUcBMgMszdDYDoor7QmZmQnWE");
